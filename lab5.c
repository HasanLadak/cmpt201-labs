...
// find where the newly freed block fits in the list.
// check if the block before it is directly adjacent, if yes, merge them (add
// sizes, link next). check if the block after it is directly adjacent, if yes,
// merge them too. done
